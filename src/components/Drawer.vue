  ...
  <div class="drawer ">
    ...
    <div class="drawer-side">
      ...
      <ul class="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
        ...
        <input type="text" v-model="content.title2" placeholder="Title 2" class="input input-bordered w-full max-w-xs" />
        <input type="text" v-model="content.date" placeholder="Date" class="input input-bordered w-full max-w-xs" />
      </ul>
    </div>
  </div>
</template>
